#' @import ggplot2
#' @export
theme_bwblack <- function (base_size = 11, base_family = "", base_line_size = base_size/22,
...
theme_classicblack <- function (base_size = 11, base_family = "", base_line_size = base_size/22,
                                base_rect_size = base_size/22)
{
